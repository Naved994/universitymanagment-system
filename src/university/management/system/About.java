...
public class About extends JFrame {
    About(){
        ...
        JLabel heading = new JLabel("<html></br> Vasantdada Patil Pratishthan College of Engineering</html>");
        heading.setBounds(70,20,400,150);
        heading.setFont(new Font("Tahoma", Font.BOLD,30));
        add(heading);

        JLabel name = new JLabel("VPPCOE");
        name.setBounds(60,260,550,40);
        name.setFont(new Font("Tahoma", Font.BOLD,30));
        add(name);

        JLabel contact = new JLabel("principal@pvppcoe.ac.in\n");
